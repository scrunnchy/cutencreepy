...
public class RepeatingBackground : MonoBehaviour
{
    ...
    private float backgroundHorizonalLength;       //A float to store the x-axis length of the collider2D attached to the Ground GameObject.
    ...
    private void Awake()
    {
        ...
        backgroundHorizonalLength = backgroundCollider.size.x;
    }
    ...
    private void Update()
    {
        ...
        if (transform.position.x < -backgroundHorizonalLength)
        {
    ...
    private void RepositionBackground()
    {
        ...
        Vector2 offSet = new Vector2(backgroundHorizonalLength * 2f, 0);
